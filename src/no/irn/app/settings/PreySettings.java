...
public class PreySettings {
	...
	private boolean asr1City;
	
	private boolean asr2City;
	...
	public static PreySettings createFromSettingsMap(
		...
		if(settings.get("cityAsr2") !=null){
			preySettings.setAsr1City(false);
			preySettings.setAsr2City(true);
		}
		else {
			preySettings.setAsr1City(true);
			preySettings.setAsr2City(false);
		}
	...
	public boolean isAsr1City() {
		return asr1City;
	}

	public void setAsr1City(boolean asr1City) {
		this.asr1City = asr1City;
	}

	public boolean isAsr2City() {
		return asr2City;
	}

	public void setAsr2City(boolean asr2City) {
		this.asr2City = asr2City;
	}
