package no.irn.app.news;

import java.util.List;

import no.irn.app.BaseActivity;
import no.irn.app.HolidayListFragment.HolidayListAdapter;
import no.irn.app.domain.HolydayItem;
import no.irn.app.domain.NewsItem;
import no.irn.app.images.ImageCacheManager;
import no.irn.app.network.GsonRequest;
import no.irn.app.news.EventListFragment.NewsListAdapter;
